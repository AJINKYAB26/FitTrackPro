...
<motion.div
  ...
  className="absolute top-10 right-10 flex items-center gap-3 px-4 py-2 rounded-full bg-gradient-to-r from-yellow-400/40 via-yellow-300/30 to-yellow-400/40 border border-yellow-300/50 backdrop-blur-md shadow-xl shadow-yellow-400/50 cursor-pointer z-50"
>
  {/* Rotating Neon Rings */}
  <motion.div
      ...
      <section className="py-24 px-4 bg-black">
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-12 rounded-3xl bg-gradient-to-br from-yellow-300/20 via-yellow-400/10 to-yellow-500/5 border border-yellow-300/30 relative">
            ...
            <Button
              onClick={() => navigate("/register")}
              className="px-15 py-4 bg-yellow-300 text-black font-bold rounded-xl hover:scale-105"
            >
              Create Free Account
            </Button>
          </div>
